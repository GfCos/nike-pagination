...
const shoeTab = [];
const shoesBlock = document.getElementById("shoesList");

settings.shoes.forEach(shoeData => {
const newShoe = new Shoe(shoeData);
shoeTab.push(newShoe);
shoesBlock.append(newShoe.getHtml);
}) 

const newPagination = new Pagination(settings.ItemsPerPage, shoeTab);

document.getElementById("pagination").append(newPagination.getHtml);
